...
namespace GroceryChef.Api.Migrations.Applications
{
    ...
    [Migration("20250609052016_Alter_Recreate_RecipeIngredient")]
    partial class Alter_Recreate_RecipeIngredient
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GroceryChef.Api.Entities.RecipeIngredient", b =>
                {
                    ...
                    b.HasIndex("IngredientsId")
                        .HasDatabaseName("ix_recipe_ingredients_ingredients_id");
            ...
            modelBuilder.Entity("GroceryChef.Api.Entities.RecipeIngredient", b =>
                {
                    ...
                    b.HasOne("GroceryChef.Api.Entities.Ingredient", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_recipe_ingredients_ingredients_ingredients_id");
                });
